const Logo = ({ className, size = 32 }: { className?: string; size?: number }) => {
  return (
    ...
    >
      ...
      <rect x="14" y="14" width="36" height="44" rx="5" stroke="#3b82f6" strokeWidth="1.4" fill="none"/>
      ...
      <text x="32" y="35" textAnchor="middle" fontFamily="Georgia, serif" fontSize="26" fontWeight="400" fill="#3b82f6" fontStyle="italic">n</text>
    </svg>
  );
};
